...
drop policy if exists "Public can read licenses" on storage.objects;
...
drop policy if exists "Public can read government ids" on storage.objects;
create policy "Public can read government ids"
  on storage.objects for select
...
drop policy if exists "Public can read certifications" on storage.objects;
